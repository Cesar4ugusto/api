...
class EditEndereçoPessoaUseCase {
    ...
    async execute(id_endereco: string, data: IRequest): Promise<void> {
        const fields = ["id_pessoa", "endereco", "numero", "bairro", "cidade", "estado", "cep", "endereco_tipo"];
        ...
        await this.model.create({ id_endereco: id_endereco, ...data });
    }
